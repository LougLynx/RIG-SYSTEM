...
namespace Manage_Receive_Issues_Goods.Data.Migrations
{
    ...
    [Migration("20250528031325_UpdateDelayReceivedTLIP")]
    partial class UpdateDelayReceivedTLIP
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Manage_Receive_Issues_Goods.Models.DelayReceivedTLIP", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Manage_Receive_Issues_Goods.Models.DelayReceivedTLIP", b =>
                {
                    b.HasOne("Manage_Receive_Issues_Goods.Models.Plandetailreceivedtlip", "Plandetailreceivedtlip")
                        .WithMany()
                        .HasForeignKey("PlanDetailId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Plandetailreceivedtlip");
                });
